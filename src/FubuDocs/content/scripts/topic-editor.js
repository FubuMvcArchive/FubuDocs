...
function TopicController(adder) {
    ...
    self.select = function (leaf) {
        ...
        // TODO -- needs to commit any changes to the previous editor
        // TODO -- set a new editor inside of the existing leaf
        // change the title on adding topics
    };
